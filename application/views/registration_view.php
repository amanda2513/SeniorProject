	...
	<div class="hero-unit wsu_hero_unit">
		...
		<div class="row-fluid">
			...
			<?php
				...
				if($selected_type=='participant'){
					echo 
					//close other column and open new column - span6
					'<div class="span6">';
					echo
						'
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="project_desc" class="span12" id="description" rows="6" placeholder="Abstract should not exceed 250 words"></textarea>
							</div>
						</div>
					</div><!--close participant only span-->
			
					
						<p class="text-center span8 offset2">
							<em>By registering, you attest to having followed all federal, state and institutional regulatory requirements in the performance of the research/scholarship.</em>
						</p>';
				}
				else{
